				...
				<div class="details-banner">
					...
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
								<asp:Image class="details-banner--info--box--img" ID="imageURL" runat="server" />
						</a>
						<h1 class="details-banner--info--name">
							<a class="details-banner--info--name--link" href="#" id="title" runat="server">
								<asp:Label runat="server" ID ="artistTitle"></asp:Label>
							</a>
							...
							<main class="discovery--section">
								...
								<section class="standard--holder">
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<li class="song-list--item media-player--row" id ="song1" runat="server">
											...
											<div class="song-list--item--right" >
												...
												<asp:Label href="#" class="song-list--item--primary" ID="SongTitle1" runat="server"></asp:Label>
												<asp:Label class="song-list--item--secondary" ID="SongAlbum1" runat="server"></asp:Label>
												<asp:Label class="song-list--item--secondary" ID="SongBPM1" runat="server"></asp:Label>
										...
										<li class="song-list--item media-player--row" id ="song2" runat="server">
											...
											<div class="song-list--item--right">
												<asp:Label href="#" class="song-list--item--primary" ID="SongTitle2" runat="server"></asp:Label>
												<asp:Label class="song-list--item--secondary" ID="SongAlbum2" runat="server"></asp:Label>
												<asp:Label class="song-list--item--secondary" ID="SongBPM2" runat="server"></asp:Label>
												<a class="song-list--item--secondary">4/4</a>
												<div class="song-list--item--icon--holder">
													<a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
														<svg class="song-list--item--icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="ds-tracks-sm"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.977 12c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10-10-4.477-10-10zm4.04 6.204a8.579 8.579 0 005.96 2.405c4.747 0 8.61-3.862 8.61-8.609 0-4.746-3.863-8.609-8.61-8.609a8.573 8.573 0 00-5.893 2.343h6.598a.708.708 0 110 1.415H4.87c-.29.423-.543.875-.754 1.348h11.213a.708.708 0 110 1.415H3.624c-.109.437-.184.888-.223 1.35h14.637a.708.708 0 110 1.414H3.396c.037.46.109.911.215 1.348h13.025a.708.708 0 010 1.416H4.087c.207.473.454.923.739 1.349h9.164a.708.708 0 110 1.415H6.017z" fill=""></path></svg>
										...
										<li class="song-list--item media-player--row" id="song3" runat="server">
											...
											<div class="song-list--item--right">
												<asp:Label href="#" class="song-list--item--primary" ID="SongTitle3" runat="server"></asp:Label>
												<asp:Label class="song-list--item--secondary" ID="SongAlbum3" runat="server"></asp:Label>
												<asp:Label class="song-list--item--secondary" ID="SongBPM3" runat="server"></asp:Label>
												<a class="song-list--item--secondary">4/4</a>
												<div class="song-list--item--icon--holder">
													<a href="#" class="song-list--item--icon--wrap" style="display: inline-block">
														<svg class="song-list--item--icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" id="ds-tracks-sm"><path fill-rule="evenodd" clip-rule="evenodd" d="M1.977 12c0-5.523 4.477-10 10-10s10 4.477 10 10-4.477 10-10 10-10-4.477-10-10zm4.04 6.204a8.579 8.579 0 005.96 2.405c4.747 0 8.61-3.862 8.61-8.609 0-4.746-3.863-8.609-8.61-8.609a8.573 8.573 0 00-5.893 2.343h6.598a.708.708 0 110 1.415H4.87c-.29.423-.543.875-.754 1.348h11.213a.708.708 0 110 1.415H3.624c-.109.437-.184.888-.223 1.35h14.637a.708.708 0 110 1.414H3.396c.037.46.109.911.215 1.348h13.025a.708.708 0 010 1.416H4.087c.207.473.454.923.739 1.349h9.164a.708.708 0 110 1.415H6.017z" fill=""></path></svg>
									...
									<section class="standard--holder">
										...
										<div class="discovery--grid-holder">
											...
											<div class="ly-grid ly-grid-cranberries">
												...
												<div class="media-item" id ="Album1" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage1" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle1" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle1" runat="server"></asp:Label>
												</div>
												<div class="media-item" id ="Album2" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage2" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle2" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle2" runat="server"></asp:Label>
												</div>
												<div class="media-item" id="Album3" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage3" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle3" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle3" runat="server"></asp:Label>
												</div>
												<div class="media-item" id ="Album4" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage4" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle4" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle4" runat="server"></asp:Label>
												</div>
												<div class="media-item" id ="Album5" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage5" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle5" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle5" runat="server"></asp:Label>
												</div>
												<div class="media-item" id="Album6" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage6" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle6" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle6" runat="server"></asp:Label>
												</div>
												<div class="media-item" id="Album7" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage7" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle7" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle7" runat="server"></asp:Label>
												</div>
												<div class="media-item" id ="Album8" runat ="Server">
													<a class="media-item--img--link" href="#" tabindex="0">
														<asp:Image class="media-item--img" ID="albumImage8" runat="server" />
														<span class="image-tag">Master</span>
													</a>
													<asp:Label class="media-item--title" ID="albumTitle8" runat="server"></asp:Label>
													<asp:Label class="media-item--subtitle" ID="albumSubTitle8" runat="server"></asp:Label>
												</div>
											</div><!-- /.grid -->
