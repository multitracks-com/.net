...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function () {
			var bioLabel = $("#artistBio");
			var readMoreLink = $("#readMoreLink");
			var fullText = bioLabel.html();
			...
			readMoreLink.click(toggleBioContent);
			...
			<main class="discovery--section">
									...
									<ItemTemplate>
										<div class="media-item">
											<a class="media-item--img--link" href="#" tabindex="0">
												<img class="media-item--img" alt="Reckless Love" src=<%#Eval("albumImageUrl") %>>
				...
				<section class="standard--holder">
					...
					<div class="artist-details--biography biography">
						<asp:Label runat="server" ID="artistBio">
							<ItemTemplate>
								<p class="bio-content">
						...
						<a href="#" id="readMoreLink">Read Less...</a>
					</div>
