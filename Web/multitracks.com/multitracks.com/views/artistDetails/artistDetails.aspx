			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<asp:Image runat="server" ID="heroBanner"/>
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
							<asp:Image runat="server" ID="artistImage"/>
						</a>
						
						<h1 class="details-banner--info--name" runat="server" ID="artistTitle"><a class="details-banner--info--name--link" href="#">Bethel Music</a></h1>
					</div>
				</div>
							...
							<main class="discovery--section">
									...
									<ul id="playlist" class="song-list mod-new mod-menu">
										<asp:Repeater runat="server" ID="songsRepeater" >
											...
											<div class="song-list--item--right">
												...
												<a href="#" class="song-list--item--primary"><%#Eval("song.songTitle") %></a>
												<a class="song-list--item--secondary"><%#Eval("albumTitle") %></a>
												<a class="song-list--item--secondary"><%#Eval("song.bpm") %></a>
												<a class="song-list--item--secondary"><%#Eval("song.timeSignature") %></a>
											...
											<div class="ly-grid ly-grid-cranberries">
												<asp:Repeater  runat="server" ID="albumsRepeater">
													...
													<a class="media-item--img--link" href="#" tabindex="0">
														<img class="media-item--img" alt="<%#Eval("album.albumTitle") %>" src="<%#Eval("album.albumImage") %>" srcset="<%#Eval("album.albumImage") %>, <%#Eval("album.albumImage") %> 2x">
														<span class="image-tag">Master</span>
													</a>
													<a class="media-item--title" href="#" tabindex="0"><%#Eval("album.albumTitle") %></a>
													<a class="media-item--subtitle" href="#" tabindex="0"><%#Eval("artistTitle") %></a>
													<span class="media-item--subtitle">
														<%#Eval("album.year") %>
													</span>
												</div>
													</ItemTemplate>
								...
								<section class="standard--holder">
									...
									<div class="artist-details--biography biography">
										<p><asp:Literal ID="biographyLiteral" runat="server" /></p>
										<%--<p><%#Eval("albumTitle") %></p>--%>
										<a href="#">Read More...</a>
									</div>
