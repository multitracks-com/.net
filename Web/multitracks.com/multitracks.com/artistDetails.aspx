...
<head>
	...
	<!-- ex.cssinclude the site stylesheet -->
	...
	<body class="premium standard u-fix-fancybox-iframe">
		<form>
			...
			<div class="wrapper mod-standard mod-gray" runat="server" id="artistImage">
					<asp:Repeater ID ="artistHeaderInfo" runat="server">
						<ItemTemplate>
							...
							<div class="details-banner" >
								...
								<div class="details-banner--hero">
									<img class="details-banner--hero--img" src="<%#Eval("artistHeroImage") %>" 
									srcset="<%#Eval("artistHeroImage") %>, 
									<%#Eval("artistHeroImage") %> 2x" alt="<%#Eval("artistTitle") %>">
								</div>
								<div class="details-banner--info">
									...
									<h1 runat="server" i="artistTitles" class="details-banner--info--name">	
												<a class="details-banner--info--name--link" href="#"><%#Eval("artistTitle") %></a>
									</h1>
								</div>
						...
						<nav class="discovery--nav">
							<ul class="discovery--nav--list tab-filter--list u-no-scrollbar">
								...
								<li class="discovery--nav--list--item tab-filter--item">
									<a class="tab-filter" href="/artistDetails.aspx/page=1">Songs</a>
								</li>
								<li class="discovery--nav--list--item tab-filter--item">
									...
									<main class="discovery--section">
											...
											<asp:Repeater ID ="artistItems" runat="server">
												...
												<li class="song-list--item media-player--row">
													...
													<div class="song-list--item--player-img media-player">
														...
														srcset=".<%#Eval("albumnImage") %> 2x" 
														src="<%#Eval("albumnImage") %>" alt="<%#Eval("songTitle") %>">
													</div>

													<div class="song-list--item--right">

														<a href="#" class="song-list--item--primary"><%#Eval("songTitle") %></a>
														<a class="song-list--item--secondary"><%#Eval("albumnTitle") %> </a>
											...
											<section class="standard--holder">
												...
												<div class="discovery--grid-holder">
													...
													<div class="ly-grid ly-grid-cranberries">
														<asp:Repeater ID ="AlbumnInfo" runat="server">
															<ItemTemplate>
															<div class="media-item">
																<a class="media-item--img--link" href="#" tabindex="0">
																	<img class="media-item--img" alt="Reckless Love" src="<%#Eval("albumnImage") %>" srcset="<%#Eval("albumnImage") %>, <%#Eval("albumnImage") %> 2x">
																	<span class="image-tag">Master</span>
																</a>
																<a class="media-item--title" href="#" tabindex="0"><%#Eval("songTitle") %></a>
																<a class="media-item--subtitle" href="#" tabindex="0"><%#Eval("albumnYear") %></a>
															</div>
															</ItemTemplate>
													</asp:Repeater>
										...
										<section class="standard--holder">
											...
											<div class="artist-details--biography biography">
											   <asp:Repeater ID ="biography" runat="server">
															<ItemTemplate>
												<p>
													<%#Eval("biography") %>
												</p>
